...
/*var initProjectsSlider=()=>{var e=document.querySelectorAll(".block_proekt_art6__slider");e.length<1||e.forEach(e=>{new Swiper(e,{slidesPerView:1,spaceBetween:10,loop:!0,navigation:{prevEl:e.querySelector(".block_proekt_art6__prev"),nextEl:e.querySelector(".block_proekt_art6__next")}})})},initInputCheck=e=>{e.forEach(e=>{e.addEventListener("input",()=>{e.classList.remove("error")})})},doFormValidation=e=>{e=e.filter(e=>e.required);0<e.length&&e.forEach(e=>{(!e.dataset.maska||e.value.length===e.dataset.maska.length)&&e.value?e.classList.remove("error"):e.classList.add("error")})},checkErorrs=e=>{return!e.some(e=>e.classList.contains("error"))},initFormValidation=r=>{var t,a=document.querySelector(".block_lidforma_art6__form");a&&(0<(t=Array.from(a.querySelectorAll(".block_lidforma_art6__input"))).length&&initInputCheck(t),console.log(t),a.addEventListener("submit",e=>{e.preventDefault(),doFormValidation(t),checkErorrs(t)&&(a.reset(),r.classList.add("success"))}))},addMask=()=>{document.querySelectorAll("[data-maska]")&&new Maska.MaskInput("[data-maska]")};document.addEventListener("DOMContentLoaded",()=>{initProjectsSlider();var e=document.querySelector(".block_lidforma_art6");e&&initFormValidation(e),addMask()});*/